...
<body>
  ...
  <script>
    function createCards(settings) {
      ...
      const cards = [
        ...
        },
        {
          ...
          +"<option value='4'" + (settings.swapRGB == '4' ? " selected='selected'" : "") + ">BRG</option>"
          +"<option value='5'" + (settings.swapRGB == '5' ? " selected='selected'" : "") + ">BGR</option>"
          +"</select>",
          icon: "fa-random",
          save: "updatePreference('swapRGB', swapRGB.value)",
          property: "swapRGB"
        },
        {
          title: "屏幕显示重影",
          ...
          icon: "fa-random",
          save: "updatePreference('clockPhase',  Number(clockPhase.checked))",
          property: "clockPhase"
        },
        {
          title: "时区",
   ...
   function updatePreference(key, value) {
      ...
      if (key=="themeName" && value.indexOf("nyan-cat")>-1){
