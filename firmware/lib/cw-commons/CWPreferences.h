...
struct ClockwiseParams
{
    ...
    const char *const PREF_SWAP_BLUE_GREEN = "swapRGB";
    ...
    const char *const PREF_CLOCK_PHASE = "clockPhase";
    const char *const THEME_NAME = "themeName";
    const char *const THEME_JSON = "themeJson";
    ...
    void save()
    {
        ...
        preferences.putBool(PREF_CLOCK_PHASE, clockPhase);
        preferences.putString(THEME_NAME, themeName);
        preferences.putString(THEME_JSON, themeJson);
    }
